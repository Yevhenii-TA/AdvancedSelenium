package ch_01_02_quick_wins.begin;
 ...
 */
    ...
    public void canSelectAnOptionUsingSelect(){
        ...
        options.get(2).click();   // select option 3

        final Long selectedIndex = (Long) ((JavascriptExecutor) driver).
                executeScript("return arguments[0].selectedIndex;",
                        selectMenu);
        Assertions.assertEquals("3",
                options.get(selectedIndex.intValue()).
                        getAttribute("value"));
    }
